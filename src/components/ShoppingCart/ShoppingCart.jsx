            ...
            <div className='max-w-7xl px-4 pb-10 mx-auto'>
              ...
              <div className='grid grid-cols-1 lg:grid-cols-3 gap-6'>
                ...
                <div className='lg:col-span-2'>
                  ...
                  {
                    cartInfo.data.products.map((p, key) => (
                      <CartItem key={key} image={p.product.imageCover} name={p.product.title} category={p.product.category.name} price={p.price} quantity={p.product.quantity} />
                    ))
                  }
                </div>
